...
import os
import json
#settings.py가 있는 폴더의 위치
PROJECT_DIR = os.path.dirname(os.path.abspath(__file__))
#manage.py가 있는 폴더의 위치
BASE_DIR = os.path.dirname(PROJECT_DIR)

# deploy.json파일을 불러와 envs변수에 저장
...
#Django의 settings.py에서 지정한 STATIC_ROOT 폴더 이름, STATID_URL, MEDIA_ROOT 폴더 이름
STATIC_ROOT_NAME = 'static'
STATIC_URL_NAME = '/static/'
MEDIA_ROOT = 'uploads'

# Fabric이 사용하는 env에 값들을 저장
